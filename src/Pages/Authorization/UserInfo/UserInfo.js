...
const UserInfo = () => {
    ...
    return (
        <div className="border-t border-gray-200 text-center pt-8 md:p-20">
            ...
            <button onClick={logOut} className="group relative w-full flex justify-center py-4 px-8 mt-10 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            >
                Log Out
            </button>
        </div>
